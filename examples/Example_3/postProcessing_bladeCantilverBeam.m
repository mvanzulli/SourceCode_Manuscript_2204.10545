...
%
timeVec = linspace(0, analysisSettings.finalTime, size(matUs3DStaticPitch, 2)) ;
angleAlpha = [] ; 
for t = timeVec
...
plot (angleAlpha(1:spanForces:end), [0;, globalReactionForcesNoPitch(3:6:end)](1:spanForces:end), ...
...
plot (angleAlpha(1:spanForces:end), [0;, globalReactionForcesPitch(3:6:end)](1:spanForces:end), ...
...
plot (angleAlpha(1:spanForces:end), [0;, globalReactionForcesNoPitch(5:6:end)](1:spanForces:end), ...
...
plot (angleAlpha(1:spanForces:end), [0;, globalReactionForcesPitch(5:6:end)](1:spanForces:end), ...
...
plot (angleAlpha(1:spanMoments:end), [0;, globalReactionForcesNoPitch(2:6:end)](1:spanMoments:end), ...
      'color', plotParams.F1colors(1,:), 'linewidth', lw, 'linestyle', ':',...
      'markersize', plotParams.F1ms(1,:), 'marker', plotParams.F1markers(1,:))
% M_x vs alpha with pitch (F2)
plot (angleAlpha(1:spanMoments:end), [0;, globalReactionForcesPitch(2:6:end)](1:spanMoments:end), ...
      'color', plotParams.F2colors(1,:), 'linewidth', lw, 'linestyle', ':',...
      'markersize', plotParams.F2ms(1,:), 'marker', plotParams.F2markers(1,:))
% axis and legend
...
plot (angleAlpha(1:spanMoments:end), [0;, globalReactionForcesNoPitch(4:6:end)](1:spanMoments:end), ...
      'color', plotParams.F1colors(1,:), 'linewidth', lw, 'linestyle', '-',...
      'markersize', plotParams.F1ms(1,:), 'marker', plotParams.F1markers(1,:))
% M_y vs alpha pitch (F2)
plot (angleAlpha(1:spanMoments:end), [0;, globalReactionForcesPitch(4:6:end)](1:spanMoments:end), ...
      'color', plotParams.F2colors(1,:), 'linewidth', lw, 'linestyle', '-',...
      'markersize', plotParams.F2ms(1,:), 'marker', plotParams.F2markers(1,:))
% M_z vs alpha no pitch (F2)
plot (angleAlpha(1:spanMoments:end), [0;, globalReactionForcesNoPitch(6:6:end)](1:spanMoments:end), ...
      'color', plotParams.F1colors(2,:), 'linewidth', lw, 'linestyle', '-',...
      'markersize', plotParams.F1ms(2,:), 'marker', plotParams.F1markers(2,:))
% M_z vs alpha pitch (F2)
plot (angleAlpha(1:spanMoments:end), [0;, globalReactionForcesPitch(6:6:end)](1:spanMoments:end), ...
      'color', plotParams.F2colors(2,:), 'linewidth', lw, 'linestyle', '-',...
      'markersize', plotParams.F2ms(2,:), 'marker', plotParams.F2markers(2,:))
% axis and legend
