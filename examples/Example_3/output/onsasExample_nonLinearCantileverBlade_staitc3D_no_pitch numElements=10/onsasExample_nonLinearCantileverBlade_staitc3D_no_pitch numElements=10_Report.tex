...
\pagestyle{fancy} 
\fancyhf{} 
\rhead{Problem: onsasExamplenonLinearCantileverBladestaitc3Dnopitch numElements=10 } 
\lfoot{Date: \today} 
\rfoot{Page \thepage} 
...
\input{onsasExample_nonLinearCantileverBlade_staitc3D_no_pitch numElements=10_iterations.tex} 
\end{longtable}
